...
const Threads: React.FC<ThreadsProps> = ({
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      program.uniforms.iResolution.value.r = container.clientWidth;
      program.uniforms.iResolution.value.g = container.clientHeight;
      program.uniforms.iResolution.value.b = container.clientWidth / container.clientHeight;
    };
    window.addEventListener('resize', resize);
    resize();

    let current = [0.5, 0.5], target = [0.5, 0.5];
